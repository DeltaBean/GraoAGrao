            ...
            >
                <Card className="w-3/4 sm:w-1/4">
                    <Box mb={{ initial: "4", sm: "7" }}>
                        ...
                        <Heading color="gray" size={{ initial: "2", sm: "3" }} as={"h2"} weight={"light"} className="sm:pl-6 sm:pr-6 sm:pt-2 text-[var(--gray)]">Please enter your username and password.</Heading>
                    </Box>
