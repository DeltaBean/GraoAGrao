        ...
        <Flex direction="column" gap="2">
          <Box className="bg-card overflow-hidden" ref={wrapperRef}>
            <Flex
              ...
              py="3"
              pb="0"
              className="bg-[var(--accent-4)] rounded-t-(--radius-3) transition-colors duration-800 ease-in-out"
            >
            ...
            <Flex
              ...
              align="center"
              p="3"
              className="bg-gradient-to-b from-[var(--accent-4)] to-[var(--accent-3)] border-b border-[var(--accent-4)] transition-colors duration-800 ease-in-out"
            >
              {renderToolbar?.(table)}
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Content size="1" variant="soft" className="w-40">
                  ...
                  <DropdownMenu.Label>
                    <Flex justify={"center"}>
                      <Text weight="light" size="1" align="center">
                        {rowHeightScale.toFixed(2)}x
                      </Text>
                    </Flex>
                  </DropdownMenu.Label>
...
function createInitialVisibility<T>(
