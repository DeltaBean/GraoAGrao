  ...
  return (
    <Flex direction="column" className="w-full" gap="4">
      <Flex direction={{ initial: "column", sm: "row" }} justify="between" p="3" gap="3">
        <Heading className="text-[var(--accent-11)]" size="6">{initialData ? "Editar Saída de Estoque" : "Criar Saída de Estoque"}</Heading>
      </Flex>
            ...
            return (
              <Card key={index} className="p-6 bg-[var(--gray-1)]">
                <Flex direction="column" gap="6">
                  <Heading size="3" mb="-2">Item de Saída</Heading>
                  <Card className="p-4 bg-[var(--gray-2)] gap-8">
                    <Flex direction="column" gap="5">
                      <Text mb="-4" size="2">Produto</Text>
                        ...
                        <>
                          <Flex direction="column" gap="3">
                            ...
                            {item.packagings.map((pack, pi) => {
                              ...
                              return (
                                <Card key={pi} className="p-4 bg-[var(--gray-2)]">
                                  <Flex direction="column" gap="4">
                                    <Text mb="-2" size="2">Porção</Text>
                                    ...
                                    {pack.item_packaging.id && (
                                      <> <DataList.Root>
                                        ...
                                        <Text mb="-2" size="2">Quantidade</Text>
